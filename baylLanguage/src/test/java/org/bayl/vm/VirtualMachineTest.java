...
public class VirtualMachineTest {
    ...
    public void testIf() {
        ...
        assertResult("if (false) { x = 'then'; } else if (true) { x = 'elseif'; } else { x = 'else'; }",
                     new BaylString("elseif"));
    }
    ...
    public void testForeach() {
        assertResult("array = [1, 2, 3]; t = 0; foreach (array as element) { t = t + element; } x = t;",
                     new BaylNumber("6"));
        assertResult("dict = {'apples':1, 'oranges':3}; t = 0; foreach (dict as k : v) { t = t + v; } x = t;",
                     new BaylNumber("4"));
    }
    ...
    public void testFunction() {
        ...
        assertResult(
                "sum = function(array) { t = 0; foreach (array as element) { t = t + element; } return t; }; t = sum([1, 2, 3]);",
                new BaylNumber("6"));
        assertResult("x = add(2, add(2, 3));", new BaylNumber("7"));
        assertResult(
                "test = function() { i = 0; while (i < 9) { i = i + 1; if (i == 5) { return i; } } return i; }; x = test();",
                new BaylNumber("5"));
    }
    ...
    public void testFunctionCall() {
        assertResult(
                "f = function() { return function() { return function() { return 'hello world'; }; }; }; x = f()()();",
                new BaylString("hello world"));
        ...
        assertResult("obj = { 'greet' : function() { return 'hello world'; } }; msg = obj['greet']();",
                     new BaylString("hello world"));
    }
}
